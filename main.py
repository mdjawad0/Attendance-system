...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'bca2022@gmail.com' ")
...
message3 = tk.Label(window, text=" Attendance System Based On Face Recognition" ,fg="white",bg="#2d420a" ,width=55 ,height=1,font=('comic', 29, ' bold '))
...
frame4.place(relx=0.35, rely=0.09, relwidth=0.23, relheight=0.07)

datef = tk.Label(frame4, text = day+"-"+mont[month]+"-"+year+"  |  ", fg="#ff61e5",bg="#2d420a" ,width=55 ,height=1,font=('comic', 22, ' bold '))
datef.pack(fill='both',expand=1)

clock = tk.Label(frame3,fg="#ff61e5",bg="#2d420a" ,width=100 ,height=1,font=('comic', 22, ' bold '))
